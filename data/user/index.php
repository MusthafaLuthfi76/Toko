...
<?php
    ...
    $reload = $_SERVER['PHP_SELF'] . "?q=" . $q; // untuk link ke halaman lain
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="120px" class="text-center">
                            <a href="mutakhir_user.php?data=<?php echo $data ['id_user']; ?>">
                                <button type="button" class="btn btn-info">
                                    <span class="glyphicon glyphicon-pencil"></span>
                                </button>
                            </a>
                            <a onclick="pesan_hapus(<?php echo $data ['id_user']; ?>);">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="form_user.php">
                <input type="button" class="btn btn-primary" value="+ Tambah Data User">
            </a>
        </div>
    </div>
</div> <!-- container -->
